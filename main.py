...
import wandb
from modeling.echomamba import echomamba
...
def main():
    ...
    my_parser.add_argument('--model_name',
                       choices=['r2plus1d_18', 'mc3_18', 'r3d_18','echomamba'],
                       default='echomamba',
                       help='Model name')
    ...
    model = echomamba(with_edge=False)
    ...
    with open(os.path.join(output, "log.csv"), "a") as f:
        ...
        if epoch_resume < args.epochs:
            run_train(output, device, model, optimizer, lr_scheduler, bestLoss, bestR2, epoch_resume, wandb, f, args)
